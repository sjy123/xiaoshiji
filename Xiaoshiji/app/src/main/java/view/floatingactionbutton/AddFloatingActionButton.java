package view.floatingactionbutton;
...
public class AddFloatingActionButton extends FloatingActionButton {
  ...
  void init(Context context, AttributeSet attributeSet) {
    ...
    mPlusColor = attr.getColor(R.styleable.AddFloatingActionButton_fab_plusIconColor, getColor(R.color.actionbar_title_color));
    attr.recycle();
